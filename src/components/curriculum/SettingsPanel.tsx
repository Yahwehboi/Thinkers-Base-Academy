  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl w-full sm:max-w-2xl max-h-[92vh] sm:max-h-[85vh] flex flex-col overflow-hidden"
      >
        {/* Header */}
        ...
        {/* Tabs */}
        <div className="flex border-b border-gray-100 flex-shrink-0 px-2 pt-2 overflow-x-auto scrollbar-none">
          {CATEGORIES.map((cat) => {
            const Icon    = cat.icon;
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1 sm:gap-1.5 px-3 sm:px-4 py-2.5 text-xs font-poppins font-semibold rounded-t-lg transition-all whitespace-nowrap ${
                  isActive
                ...
                >
                  ...
                  {item.id && (
                    <button
                      ...
                      className="w-7 h-7 flex items-center justify-center rounded-lg text-charcoal/30 hover:text-red-500 hover:bg-red-50 transition-all sm:opacity-0 sm:group-hover:opacity-100"
                      title="Remove"
                    >
